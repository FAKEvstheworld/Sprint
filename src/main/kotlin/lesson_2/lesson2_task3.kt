...
fun main() {
    ...
    val departureTime = hourOfDeparture* MINUTES_IN_A_HOUR+minuteOfDeparture // время отправления конвертированное в минуты (579)
    ...
    val arrivalMinute = arrivalTime/ MINUTES_IN_A_HOUR% MINUTES_IN_A_HOUR // минута прибытия (17)
